...
declare module 'zlib' {
     ...
     *      @return 返回封装过的流对象
     */
    function createGunzip(to: Class_Stream): Class_Stream;
     ...
     *      @return 返回封装过的流对象
     */
    function createInflate(to: Class_Stream): Class_Stream;
     ...
     *      @return 返回封装过的流对象
     */
    function createInflateRaw(to: Class_Stream): Class_Stream;
     ...
     *      
     */
    function inflate(data: Class_Buffer): Class_Buffer;

    function inflate(data: Class_Buffer, callback: (err: Error | undefined | null, retVal: Class_Buffer)=>any): void;
     ...
     *      
     */
    function inflateTo(data: Class_Buffer, stm: Class_Stream): void;

    function inflateTo(data: Class_Buffer, stm: Class_Stream, callback: (err: Error | undefined | null)=>any): void;
     ...
     *      
     */
    function inflateTo(src: Class_Stream, stm: Class_Stream): void;

    function inflateTo(src: Class_Stream, stm: Class_Stream, callback: (err: Error | undefined | null)=>any): void;
     ...
     *      
     */
    function gunzip(data: Class_Buffer): Class_Buffer;

    function gunzip(data: Class_Buffer, callback: (err: Error | undefined | null, retVal: Class_Buffer)=>any): void;
     ...
     *      
     */
    function gunzipTo(data: Class_Buffer, stm: Class_Stream): void;

    function gunzipTo(data: Class_Buffer, stm: Class_Stream, callback: (err: Error | undefined | null)=>any): void;
     ...
     *      
     */
    function gunzipTo(src: Class_Stream, stm: Class_Stream): void;

    function gunzipTo(src: Class_Stream, stm: Class_Stream, callback: (err: Error | undefined | null)=>any): void;
     ...
     *      
     */
    function inflateRaw(data: Class_Buffer): Class_Buffer;

    function inflateRaw(data: Class_Buffer, callback: (err: Error | undefined | null, retVal: Class_Buffer)=>any): void;
     ...
     *      
     */
    function inflateRawTo(data: Class_Buffer, stm: Class_Stream): void;

    function inflateRawTo(data: Class_Buffer, stm: Class_Stream, callback: (err: Error | undefined | null)=>any): void;
     ...
     *      
     */
    function inflateRawTo(src: Class_Stream, stm: Class_Stream): void;

    function inflateRawTo(src: Class_Stream, stm: Class_Stream, callback: (err: Error | undefined | null)=>any): void;
